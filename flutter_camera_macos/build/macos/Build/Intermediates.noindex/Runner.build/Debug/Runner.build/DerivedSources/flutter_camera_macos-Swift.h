...
#ifndef FLUTTER_CAMERA_MACOS_SWIFT_H
#define FLUTTER_CAMERA_MACOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flutter_camera_macos",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC20flutter_camera_macos11AppDelegate")
...
SWIFT_CLASS("_TtC20flutter_camera_macos17MainFlutterWindow")
